...
where (tec.tematica_id,tec.competicion_id) IN (
    SELECT r.tematica_id, r.competicion_id
      FROM rima r
     GROUP BY r.tematica_id, r.competicion_id
...
--de DDL pero para un mejor orden lo dejo acá.
...
--Este punto debería estar en el archivo de DDL pero para un mejor orden lo dejo acá.
